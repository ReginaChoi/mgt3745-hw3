...
|---|---|---|---|---|---|
| AC-1 | Load the page. Select each career path in the dropdown in turn. | The skill list updates to that path's skills, visibly within 2 seconds. | Selected Audit and the audit skills appeared immediately. Selected Forensic Accounting and the list changed to the forensic accounting skills immediately. All paths updated in less than 2 seconds. | PASS | ![Screenshot: AC-1](image.png) |
| AC-2 | Select a path, select a skill, type valid evidence text (1 to 200 characters), click Save evidence. | The skill's status changes from "Not yet evidenced" to "Evidenced" and the entered text appears under it. | Selected Forensic Accounting and the selected skill. Entered 'MGT 4029' and clicked Save evidence. The skill changed to 'Evidenced' and the evidence text appeared underneath. | PASS | ![Screenshot: AC-2](image-1.png) |
| AC-3a | Leave the skill dropdown on "Choose a skill," type some evidence text, click Save evidence. | An error message appears asking to choose a skill first; the typed text stays in the input. | Left the skill dropdown on 'Choose a skill,' entered 'IRS case,' and clicked Save evidence. An error message appeared telling me to choose a skill, and 'IRS case' remained in the input. | PASS | ![Screenshot: AC-3a](image-2.png)|
| AC-3b | Select a skill, leave the evidence input empty, click Save evidence. | An error message appears asking for 1 to 200 characters; the input stays empty as entered. | Selected a skill with the evidence input empty and clicked Save evidence. An error appeared stating that 1 to 200 characters are required. The input remained empty. | PASS | ![Screenshot: AC-3b](image-3.png)|
| AC-4 | Open the page with `?failSave` in the URL. Select a path and skill, type evidence, click Save evidence. | A save error appears, the typed text remains in the input, and the skill's status does not change to evidenced. | A save error appeared, the evidence text remained in the input, and the skill did not change to 'Evidenced'. | PASS | ![Screenshot: AC-4](image-4.png) |
| AC-5 | Load a path with no evidence yet attached to any of its skills. | Every skill on that path reads "Not yet evidenced." | All three skills on the Audit Career path say 'Not yet evidenced'. | PASS | ![Screenshot: AC-5](image-5.png) |
| AC-6 | Inspect the rendered page and the stored data (Application tab, Local Storage) after saving evidence. | Only the current browser's own evidence is present; no other student's data is displayed anywhere, since none is fetched from any other source. | Application > Local Storage showed only the evidence I entered during testing. No other student's data was present or displayed. | PASS | ![Screenshot: AC-6](image-6.png) |
| Persistence (supports AC-2, not a separate acceptance statement) | Save evidence for a skill, then reload the page (not just re-select the path). | The previously saved evidence and "Evidenced" status are still present after reload. | Saved evidence for the selected skill, reloaded the entire page, and the evidence and 'Evidenced' status were still present. | PASS | ![Screenshot: Persistence](image-7.png) |
